...
<g transform="translate({x},{y})" on:mousewheel|stopPropagation|preventDefault={e => mousewheel(e)}>
  <g transform="rotate({rot})">
    <circle r=10 />
    <circle r=2 class="dot" cy=-5/>
  </g>
  <g>
    <DigitalDisplay fontSize=8 text={value.toFixed(2)} width={20} y={15} x={-14} />
  </g>
</g>